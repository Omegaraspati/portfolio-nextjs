    ...
    z-30 rounded-lg bg-white shadow-xl ring-1 ring-slate-100 '>
      <div className='flexBetween max-container'>
        <Link href="/" className=' bold-28 capitalize relative'>
          My<span className='text-blue-700'>Portfolio</span>
        ...
        <div>
          <button id="hs-dropdown-custom-icon-trigger" type="button" className="lg:hidden hs-dropdown-toggle flex justify-center items-center size-9 text-sm font-semibold rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm">
            <Image
              src="menu.svg" alt="menu"
              width={28}
              height={28}
              className='inline-block cursor-pointer lg:hidden' /></button>
        </div>
      </div>
    </nav>
  )
