...
const Steps = () => {
  ...
  <div className="after:mt-4 after:block after:h-1 after:w-full after:rounded-lg after:bg-gray-200">
    <ol className="grid grid-cols-3 text-sm font-medium text-blue-600">
      <li className="relative flex justify-start text-blue-600">
        ...
        <span className="hidden sm:block"> PT. HAFARA CANTIK INDONESIA </span>
      ...
      <li className="relative flex justify-center text-blue-600">
        ...
        <span className="hidden sm:block"> PT. EMWAY GLOBALINDO </span>
      ...
      <li className="relative flex justify-end">
        <span className="absolute -bottom-[1.75rem] end-0 rounded-full bg-blue-600 text-white">
          <svg
            className="h-5 w-5"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
        ...
        <span className="hidden sm:block text-blue-600"> KRENIES INDONESIA </span>
