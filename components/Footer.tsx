...
const Footer = () => {
  return (
    <footer className='max-container padding-container bg-green-90 bg-pattern bg-cover bg-ccenter bg-no-repeat px-6 pt-24 pb-8 text-white'>
      <div className='flex flexBetween flex-col gap-14 md:flex-row pb-16'>
        ...
        <ul className='regular-14 flex gap-4 text-gray-30'>
          {
            SOCIALS.map((social) => (
              <Link href={social.href} key={social.key} className='h-10 w-10border-[0.01rem] 
