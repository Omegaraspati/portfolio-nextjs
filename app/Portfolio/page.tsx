...
const page = () => {
  return (
    ...
    py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row bg-[#f7f7f7]'>
      ...
      <a href="https://drive.google.com/drive/folders/1-QkBKMqF9mhoL5xOiTZjxUSIpFMKUWDm?usp=drive_link" target="blank" className='flex justify-center mx-auto pb-10'>
        <Button type='button'
      ...
      <a href="https://drive.google.com/drive/folders/1-QfN3x_thDJ87d9g8BZJeWtdxjNcKMVx?usp=drive_link" target="blank" className='flex justify-center mx-auto pb-10'>
        <Button type='button'
      ...
      <div className='text-center bold-18 uppercase 
      tracking-[1rem] text-blue-500 pb-20 pt-10 '>Videography </div>
      <a href="https://drive.google.com/drive/folders/1-Z_KbuFLwpjq9C431TnkBsKPtejxzC6f?usp=drive_link" target="blank" className='flex justify-center mx-auto pb-10'>
        <Button type='button'
          title='Videography Gallery'
          icon='/readmore.svg'
          variant='btn_dark_rounded
          '/></a>
      <div className="grid border pb-20 rounded-xl mx-24 gap-10 shadow-sm divide-y overflow-hidden sm:flex sm:divide-y-0 sm:divide-x dark:border-neutral-700 dark:shadow-neutral-700/70 dark:divide-neutral-600">
        <div className="flex flex-col flex-[1_0_0%] bg-white dark:bg-neutral-800">
          <video className="w-full h-auto rounded-t-xl sm:rounded-se-none" src="/images/1212.MOV" controls />
          <div className="p-4 border-t sm:px-5 dark:border-neutral-700">
            <p className="text-xs text-gray-500 dark:text-neutral-500">
              Taken by IPhone 11 Pro Max
            </p>
        ...
        <div className="flex flex-col flex-[1_0_0%] bg-white dark:bg-neutral-800">
          <video className="w-full h-auto rounded-t-xl sm:rounded-se-none" src="/images/1313.MOV" controls />
          <div className="p-4 border-t sm:px-5 dark:border-neutral-700">
            <p className="text-xs text-gray-500 dark:text-neutral-500">
              Taken by IPhone 11 Pro Max
            </p>
        ...
        <div className="flex flex-col flex-[1_0_0%] bg-white dark:bg-neutral-800">
          <video className="w-full h-auto rounded-t-xl sm:rounded-se-none" src="/images/1414.MOV" controls />
          <div className="p-4 border-t sm:px-5 dark:border-neutral-700">
            <p className="text-xs text-gray-500 dark:text-neutral-500">
              Taken by IPhone 11 Pro Max
            </p>
      ...
      <div className="grid border pb-20 rounded-xl mx-24 gap-10 shadow-sm divide-y overflow-hidden sm:flex sm:divide-y-0 sm:divide-x dark:border-neutral-700 dark:shadow-neutral-700/70 dark:divide-neutral-600">
        <div className="flex flex-col flex-[1_0_0%] bg-white dark:bg-neutral-800">
          <video className="w-full h-auto rounded-t-xl sm:rounded-se-none" src="/images/1515.MOV" controls />
          <div className="p-4 border-t sm:px-5 dark:border-neutral-700">
            <p className="text-xs text-gray-500 dark:text-neutral-500">
              Taken by IPhone 11 Pro Max
            </p>
        ...
        <div className="flex flex-col flex-[1_0_0%] bg-white dark:bg-neutral-800">
          <video className="w-full h-auto rounded-t-xl sm:rounded-se-none" src="/images/1616.MOV" controls />
          <div className="p-4 border-t sm:px-5 dark:border-neutral-700">
            <p className="text-xs text-gray-500 dark:text-neutral-500">
              Taken by IPhone 11 Pro Max
            </p>
        ...
        <div className="flex flex-col flex-[1_0_0%] bg-white dark:bg-neutral-800">
          <video className="w-full h-auto rounded-t-xl sm:rounded-se-none" src="/images/1717.MOV" controls />
          <div className="p-4 border-t sm:px-5 dark:border-neutral-700">
            <p className="text-xs text-gray-500 dark:text-neutral-500">
              Taken by IPhone 11 Pro Max
            </p>
